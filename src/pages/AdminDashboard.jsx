...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static z-50 w-64 h-screen bg-slate-900 text-white
      ...
      >
        ...
        <nav className="p-4 space-y-2 text-sm">
          {["Dashboard", "Students", "Rooms", "Seats", "Review", "Logout"].map(
            (item) => (
              <div
                key={item}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-4">
          <button
            onClick={() =>
              handleEdit(
                { name: "", room: "", seat: "", expiry: "", mobile: "", email: "" },
                data.length
              )
            }
        ...
        <div className="px-4 pb-6 overflow-x-auto">
          <table className="w-full bg-white rounded-xl shadow text-sm">
            <thead className="bg-gray-100">
              <tr>
                {["Name", "Room", "Seat", "Expiry", "Mobile", "Email", "Actions"].map(
                  (h) => (
